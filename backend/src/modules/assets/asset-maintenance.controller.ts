...
export async function listAssetMaintenance(req: Request, res: Response) {
  try {
...
export async function getAssetMaintenance(req: Request, res: Response) {
  try {
    const { id } = req.params;
...
export async function createAssetMaintenance(req: Request, res: Response) {
  try {
...
export async function updateAssetMaintenance(req: Request, res: Response) {
  try {
    const { id } = req.params;
...
export async function deleteAssetMaintenance(req: Request, res: Response) {
  try {
    const { id } = req.params;
