...
function resolveText(
  ...
  employee: RenderOptions["employee"],
  issueDate: Date,
  expiryDate?: Date | null
) {
...
function getTextFont(settings: IdCardTemplateSettings, weight: "normal" | "bold" = "normal", size?: number) {
...
async function writePdfFromPng(buffer: Buffer, pdfPath: string, width: number, height: number) {
