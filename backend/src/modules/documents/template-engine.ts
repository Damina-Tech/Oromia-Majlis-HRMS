 ...
 */
async function getEmployeeData(employeeId: string): Promise<MergeFieldData["employee"]> {
 ...
 */
async function getDepartmentData(departmentId: string): Promise<MergeFieldData["department"]> {
 ...
 */
async function getPayrollData(employeeId: string): Promise<MergeFieldData["payroll"]> {
 ...
 */
function getCompanyData(): MergeFieldData["company"] {
  return {
    name: "Chiro HRMS",
 ...
 */
function getDateData(): MergeFieldData["date"] {
  const now = new Date();
  return {
 ...
 */
function getSampleData(): MergeFieldData {
  return {
    employee: {
      firstName: "John",
      lastName: "Doe",
 ...
 */
function resolveMergeField(data: MergeFieldData, fieldPath: string): string {
...
export async function processTemplate(
  content: string,
  employeeId?: string,
  customMergeData?: Record<string, any>,
  useSampleData: boolean = false
): Promise<string> {
  let mergeData: MergeFieldData;
