...
import { createTask, listTasks, getTask, updateTask, deleteTask, addComment, addTimeLog, bulkUpdateTasks, getTaskStats, uploadAttachment, downloadAttachment, deleteAttachment, } from "./task.controller.js";
...
// Task attachments
router.post("/:id/attachments", hasPermission("tasks.edit"), uploadTaskAttachment.single("file"), uploadAttachment);
