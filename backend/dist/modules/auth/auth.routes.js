...
router.post("/login", async (req, res) => {
    ...
    const permissions = buildEffectivePermissionNames(user.userRoles, user.userPermissions);
...
router.post("/register", async (req, res) => {
    try {
        ...
        const permissions = buildEffectivePermissionNames(newUser.userRoles, newUser.userPermissions);
