...
import { CheckInDto, CheckOutDto, ListAttendanceQuery, CreateAttendanceDto, UpdateAttendanceDto, } from "./attendance.dto.js";
...
export async function updateAttendance(req, res) {
    try {
        ...
        if (body.checkInTime !== undefined)
            updateData.checkInTime = body.checkInTime ? new Date(body.checkInTime) : null;
        if (body.checkOutTime !== undefined)
            updateData.checkOutTime = body.checkOutTime ? new Date(body.checkOutTime) : null;
        if (body.checkInLocation !== undefined)
            updateData.checkInLocation = body.checkInLocation || null;
        if (body.checkOutLocation !== undefined)
            updateData.checkOutLocation = body.checkOutLocation || null;
