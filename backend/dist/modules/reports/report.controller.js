...
function getDateRangeFilter(dateRange, startDate, endDate) {
    const now = new Date();
    let start;
...
export async function generateReport(req, res) {
    try {
        ...
        const dateFilter = getDateRangeFilter(filters.dateRange, filters.startDate, filters.endDate);
        let reportData = [];
        let metadata = {
            totalRows: 0,
 ...
 * Employee Reports
 */
async function generateEmployeeReport(where, dateFilter, filters, reportType) {
 ...
 * Department Reports
 */
async function generateDepartmentReport(where, dateFilter, filters, reportType) {
 ...
 * Leave Reports
 */
async function generateLeaveReport(where, dateFilter, filters, reportType) {
    const leaveWhere = {
        ...where,
        startDate: {
 ...
 * Attendance Reports
 */
async function generateAttendanceReport(where, dateFilter, filters, reportType) {
 ...
 * Payroll Reports
 */
async function generatePayrollReport(where, dateFilter, filters, reportType) {
    const payrollWhere = {
        ...where,
        payPeriodStart: {
            gte: dateFilter.start,
 ...
 * Task Reports
 */
async function generateTaskReport(where, dateFilter, filters, reportType) {
    const taskWhere = {
        ...where,
        createdAt: {
            gte: dateFilter.start,
 ...
 * Asset Reports
 */
async function generateAssetReport(where, dateFilter, filters, reportType) {
    const assetWhere = {
        ...where,
 ...
 * Expense Reports
 */
async function generateExpenseReport(where, dateFilter, filters, reportType) {
    const expenseWhere = {
        ...where,
        incurredDate: {
            gte: dateFilter.start,
 ...
 * Document Reports
 */
async function generateDocumentReport(where, dateFilter, filters, reportType) {
    const documentWhere = {
        ...where,
        createdAt: {
            gte: dateFilter.start,
 ...
 * Timesheet Reports
 */
async function generateTimesheetReport(where, dateFilter, filters, reportType) {
 ...
 */
export async function getReportAuditLogs(req, res) {
    try {
        const query = {
