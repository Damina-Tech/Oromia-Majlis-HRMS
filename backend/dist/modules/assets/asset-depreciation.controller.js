...
export async function listAssetDepreciation(req, res) {
    try {
...
export async function getAssetDepreciation(req, res) {
    try {
        const { id } = req.params;
    ...
    try {
        ...
        for (const asset of assets) {
            try {
                ...
                const depreciation = calculateDepreciation(purchasePrice, asset.depreciationMethod, parseFloat(asset.depreciationRate.toString()), parseFloat(asset.lifeYears.toString()), yearsElapsed);
...
//# sourceMappingURL=asset-depreciation.controller.js.map