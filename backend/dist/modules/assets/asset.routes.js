...
import { listAssets, getAsset, createAsset, updateAsset, assignAsset, returnAsset, deleteAsset, getAssetStats, getAssetHistory, bulkUpdateAssets, } from "./asset.controller.js";
import { listAssetCategories, getAssetCategory, createAssetCategory, updateAssetCategory, deleteAssetCategory, } from "./asset-category.controller.js";
import { listAssetLocations, getAssetLocation, createAssetLocation, updateAssetLocation, deleteAssetLocation, } from "./asset-location.controller.js";
import { listAssetVendors, getAssetVendor, createAssetVendor, updateAssetVendor, deleteAssetVendor, } from "./asset-vendor.controller.js";
import { listAssetMaintenance, getAssetMaintenance, createAssetMaintenance, updateAssetMaintenance, deleteAssetMaintenance, } from "./asset-maintenance.controller.js";
import { listAssetDisposals, getAssetDisposal, createAssetDisposal, } from "./asset-disposal.controller.js";
import { listAssetDepreciation, getAssetDepreciation, runDepreciation, } from "./asset-depreciation.controller.js";
const router = Router();
