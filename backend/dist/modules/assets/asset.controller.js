...
import { CreateAssetDto, UpdateAssetDto, AssignAssetDto, TransferAssetDto, UpdateAssetStatusDto, ListAssetsQuery, AssetStatsQuery, AssetHistoryQuery, BulkUpdateAssetsDto, } from "./asset.dto.js";
...
export async function getAssetStats(req, res) {
    try {
        ...
        const [totalAssets, statusCounts, conditionCounts, categoryCounts, totalValue,] = await Promise.all([
            prisma.asset.count({ where }),
