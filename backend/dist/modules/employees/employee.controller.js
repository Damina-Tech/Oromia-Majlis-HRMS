...
export async function listEmployees(req, res) {
    ...
    const statusTotals = overallCounts.reduce((acc, item) => {
        ...
        const emp = await prisma.$transaction(async (tx) => {
            ...
            if (shouldCreateUser) {
                try {
                    ...
                    const normalizedError = userError instanceof Error ? userError : new Error("Failed to create user account.");
...
export async function updateEmployee(req, res) {
    ...
    if (dto.dateOfBirth !== undefined)
        updateData.dateOfBirth = dto.dateOfBirth === "" ? null : (dto.dateOfBirth ? new Date(dto.dateOfBirth) : null);
    if (dto.gender !== undefined)
        updateData.gender = dto.gender === "" ? null : dto.gender;
    if (dto.address !== undefined)
        updateData.address = dto.address === "" ? null : dto.address;
    if (dto.emergencyContact !== undefined)
        updateData.emergencyContact = dto.emergencyContact === "" ? null : dto.emergencyContact;
    if (dto.designation !== undefined)
        updateData.designation = dto.designation === "" ? null : dto.designation;
    if (dto.employmentType !== undefined)
        updateData.employmentType = dto.employmentType === "" ? null : dto.employmentType;
    if (dto.educationLevel !== undefined)
        updateData.educationLevel = dto.educationLevel === "" ? null : dto.educationLevel;
    if (dto.educationOther !== undefined)
        updateData.educationOther = dto.educationOther === "" ? null : dto.educationOther;
    if (dto.educationField !== undefined)
        updateData.educationField = dto.educationField === "" ? null : dto.educationField;
    if (dto.marriageStatus !== undefined)
        updateData.marriageStatus = dto.marriageStatus === "" ? null : dto.marriageStatus;
    if (dto.document !== undefined)
        updateData.document = dto.document === "" ? null : dto.document;
    if (dto.avatarUrl !== undefined)
        updateData.avatarUrl = dto.avatarUrl === "" ? null : dto.avatarUrl;
    if (dto.status !== undefined)
        updateData.status = dto.status;
    if (dto.joiningDate !== undefined)
        updateData.joiningDate = dto.joiningDate === "" ? null : (dto.joiningDate ? new Date(dto.joiningDate) : null);
    if (dto.salary !== undefined)
        updateData.salary = dto.salary ?? null;
    if (dto.departmentId !== undefined)
        updateData.departmentId = dto.departmentId === "" || dto.departmentId.trim() === "" ? null : dto.departmentId;
    if (dto.managerId !== undefined)
        updateData.managerId = dto.managerId === "" || dto.managerId.trim() === "" ? null : dto.managerId;
    ...
    if (emp.user) {
        ...
        if (dto.firstName !== undefined)
            userProfileUpdates.firstName = dto.firstName;
        if (dto.lastName !== undefined)
            userProfileUpdates.lastName = dto.lastName;
        if (dto.avatarUrl !== undefined)
            userProfileUpdates.avatarUrl = dto.avatarUrl === "" ? null : dto.avatarUrl;
        if (dto.status !== undefined) {
...
export async function bulkImportEmployees(req, res) {
    try {
        ...
        const existingEmails = new Set((await prisma.employee.findMany({ select: { email: true } })).map(e => e.email.toLowerCase()));
