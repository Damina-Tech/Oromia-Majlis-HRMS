...
import { listEmployees, getEmployee, createEmployee, updateEmployee, deleteEmployee, downloadSampleTemplate } from "./employee.controller.js";
import { hasAnyPermission, hasPermission } from "../../middleware/auth.js";
import { batchGenerateEmployeeIdCards, createIdCardTemplate, deleteIdCardTemplate, generateEmployeeIdCard, listIdCardTemplates, setDefaultIdCardTemplate, updateIdCardTemplate, } from "./employee-id.controller.js";
const router = Router();
...
router.get("/id-templates", hasAnyPermission("employees.id.generate", "employees.id.manage"), listIdCardTemplates);
...
router.post("/id-templates/:templateId/default", hasPermission("employees.id.manage"), setDefaultIdCardTemplate);
// ID generation routes
router.post("/:id/id-card", hasAnyPermission("employees.id.generate", "employees.id.manage"), generateEmployeeIdCard);
