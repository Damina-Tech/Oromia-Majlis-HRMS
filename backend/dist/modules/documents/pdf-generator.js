 ...
 */
export async function generatePDFFromHTML(htmlContent, outputFileName) {
 ...
 */
export function generateDocumentFileName(templateCode, employeeCode, extension = "pdf") {
 ...
 */
export async function cleanupOldDocuments(olderThanDays) {
    try {
