...
import { CreateDocumentSettingsDto, UpdateDocumentSettingsDto, } from "./document-settings.dto.js";
 ...
 */
export async function getDocumentSettings(req, res) {
    try {
 ...
 */
export async function createDocumentSettings(req, res) {
    try {
 ...
 */
export async function updateDocumentSettings(req, res) {
    try {
        const currentUserId = getCurrentUserId(req);
