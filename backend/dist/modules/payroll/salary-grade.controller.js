...
import { CreateSalaryGradeDto, UpdateSalaryGradeDto, CreateSalaryStepDto, UpdateSalaryStepDto, } from "./salary-grade.dto.js";
const prisma = new PrismaClient();
// ========== Salary Grade CRUD ==========
export async function createSalaryGrade(req, res) {
    try {
...
export async function listSalaryGrades(req, res) {
    try {
...
export async function getSalaryGrade(req, res) {
    try {
        const { id } = req.params;
...
export async function updateSalaryGrade(req, res) {
    try {
        const { id } = req.params;
        ...
        if (dto.minSalary !== undefined)
            updateData.minSalary = new Prisma.Decimal(dto.minSalary);
        if (dto.maxSalary !== undefined)
            updateData.maxSalary = new Prisma.Decimal(dto.maxSalary);
...
export async function deleteSalaryGrade(req, res) {
    try {
        const { id } = req.params;
...
// ========== Salary Step CRUD ==========
export async function createSalaryStep(req, res) {
    try {
...
export async function listSalarySteps(req, res) {
    try {
...
export async function getSalaryStep(req, res) {
    try {
        const { id } = req.params;
...
export async function updateSalaryStep(req, res) {
    try {
        const { id } = req.params;
...
export async function deleteSalaryStep(req, res) {
    try {
        const { id } = req.params;
...
//# sourceMappingURL=salary-grade.controller.js.map