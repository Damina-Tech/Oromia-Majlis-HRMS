...
import { CreateAdvanceDto, UpdateAdvanceDto, ApproveAdvanceDto, AddAdvanceRepaymentDto, ListAdvanceQuery, } from "./advance.dto.js";
...
export async function updateAdvance(req, res) {
    try {
        ...
        if (dto.monthlyDeduction !== undefined)
            updateData.monthlyDeduction = new Prisma.Decimal(dto.monthlyDeduction);
        if (dto.status)
...
export async function addAdvanceRepayment(req, res) {
    try {
        const { id } = req.params;
