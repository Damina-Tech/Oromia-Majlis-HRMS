...
import { CreateSalaryIncrementDto, BulkIncrementDto, ListSalaryIncrementQuery, } from "./salary-increment.dto.js";
...
export async function bulkIncrement(req, res) {
    try {
...
export async function getSalaryIncrement(req, res) {
    try {
        const { id } = req.params;
        const currentUserEmployeeId = req.user?.employeeId;
        const userRoles = req.user?.roles || [];
...
//# sourceMappingURL=salary-increment.controller.js.map