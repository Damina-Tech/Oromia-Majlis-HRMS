...
import { CreateLeaveRequestDto, UpdateLeaveStatusDto, ListLeaveRequestsQuery, } from "./leave.dto.js";
...
export async function updateLeaveStatus(req, res) {
    try {
        ...
        const approverId = req.user?.employeeId || null; // Admin might not have employee record
        const leave = await prisma.leaveRequest.findUnique({
            where: { id: req.params.id },
