    ...
    <div className="p-6 space-y-6 max-w-2xl mx-auto">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-sm">Register your business for Halal certification</p>
        </div>
      </div>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-2 pt-4">
              <Button type="button" variant="outline" onClick={() => navigate("/halal/dashboard")}>
                Cancel
              </Button>
