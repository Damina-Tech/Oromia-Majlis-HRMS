          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {loadingNotifications ? (
                <p className="text-sm text-muted-foreground">Loading notification preferencesΓÇª</p>
              ) : (
            ...
            <CardContent>
              <form className="space-y-6" onSubmit={handleEmployeeSettingsSave}>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                      Automatically enable the ΓÇ£Create User AccountΓÇ¥ option when adding a new employee.
                  </p>
                </div>
                <Switch
