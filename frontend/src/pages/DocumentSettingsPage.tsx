  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">Customize company branding, stamps, and localization</p>
      </div>
          ...
          <TabsContent value="stamp">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure official stamp and signature images</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData({ ...formData, stampImage: e.target.value })}
                    placeholder="https://example.com/stamp.png"
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    URL or path to official stamp image
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    URL or path to signature image
                  </p>
                </div>
